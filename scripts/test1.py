...
grammar = f""" I have collection Grammar for this sentence essay below ```
...
vocabulary = f""" I have collection Vocabulary for this sentence essay below ```
...
Collection Grammar delimited by ``` above, \
Collection vocabulary delimited by ``` above, \
...
When I say 1 2 3, then the action is performed.
Student essay: ```{essay}```
"""
